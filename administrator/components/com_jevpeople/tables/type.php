...
class TableType extends JTable
{
	...
	/**
	 * @var string
	 * the Joomla user groups that can be self allocated
	 */
	var $allowedgroups = "";	
	...
	function bind($array, $ignore = '') {
		if (isset($array["allowedgroups"]) && is_array($array["allowedgroups"])){
			JArrayHelper::toInteger($array["allowedgroups"]);
			$array["allowedgroups"] = json_encode($array["allowedgroups"]);
		}
