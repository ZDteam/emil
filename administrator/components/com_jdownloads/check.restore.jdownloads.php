...
// *******************************************************************************************
      ...
      $sum_configs = 0;
        ...
        */
        ...
        $table = $prefix.'jdownloads_license';
        $result = $database->getTableColumns( $table );
        ...
        $table = $prefix.'jdownloads_templates';
        $result = $database->getTableColumns( $table );
        ...
        $table = $prefix.'jdownloads_groups';
        $result = $database->getTableColumns( $table );
        ...
        $table = $prefix.'jdownloads_rating';
        $result = $database->getTableColumns( $table );
