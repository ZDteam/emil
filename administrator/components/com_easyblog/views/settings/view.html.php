...
class EasyBlogViewSettings extends EasyBlogAdminView
{
	function display($tpl = null)
	{
		...
		if(file_exists( JPATH_ROOT . DIRECTORY_SEPARATOR . 'components' . DIRECTORY_SEPARATOR . 'com_jcomments' . DIRECTORY_SEPARATOR . 'jcomments.php' ))
		{
		...
		if(file_exists( JPATH_ROOT . DIRECTORY_SEPARATOR . 'components' . DIRECTORY_SEPARATOR . 'com_rscomments' . DIRECTORY_SEPARATOR . 'rscomments.php' ))
		{
