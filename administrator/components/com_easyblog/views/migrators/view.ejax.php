...
class EasyBlogViewMigrators extends EasyBlogAdminView
{
	...
	public function _migrateK2Images( &$row , &$blog , $author )
	{
		...
		$path	= JPATH_ROOT . DIRECTORY_SEPARATOR . 'media' . DIRECTORY_SEPARATOR . 'k2' . DIRECTORY_SEPARATOR . 'items' . DIRECTORY_SEPARATOR . 'src' . DIRECTORY_SEPARATOR . $name . '.jpg';
		$config	= EasyBlogHelper::getConfig();
		$configStorage		= str_ireplace( '\\' , DIRECTORY_SEPARATOR , $config->get( 'main_image_path' ) );
		$newPath			= JPATH_ROOT . DIRECTORY_SEPARATOR . $configStorage . DIRECTORY_SEPARATOR . $author->id;
		...
		if( JFile::exists( $path ) )
		{
			...
			$large				= JPATH_ROOT . DIRECTORY_SEPARATOR . 'media' . DIRECTORY_SEPARATOR . 'k2' . DIRECTORY_SEPARATOR . 'items' . DIRECTORY_SEPARATOR . 'cache' . DIRECTORY_SEPARATOR . $name . '_XL.jpg';
			$targetLarge		= $newPath . DIRECTORY_SEPARATOR . $name . '.jpg';
			$largeSrc			= rtrim( JURI::root() , '/' ) . '/' . str_ireplace( '\\' , '/' , $configStorage ) . '/' . $author->id . '/' . $name . '.jpg';
			@JFile::copy( $large , $targetLarge );

			$medium				= JPATH_ROOT . DIRECTORY_SEPARATOR . 'media' . DIRECTORY_SEPARATOR . 'k2' . DIRECTORY_SEPARATOR . 'items' . DIRECTORY_SEPARATOR . 'cache' . DIRECTORY_SEPARATOR . $name . '_M.jpg';
			$targetMedium		= $newPath . DIRECTORY_SEPARATOR . EBLOG_MEDIA_THUMBNAIL_PREFIX . $name . '.jpg';
