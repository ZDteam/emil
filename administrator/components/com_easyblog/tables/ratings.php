	...
	public function store($updateNulls = false)
	{
		...
		if( $this->type == 'entry' && $this->created_by )
		{
			...
			if( $config->get( 'integrations_jomsocial_notification_rating' ) )
			{
				...
				EasyBlogHelper::getHelper( 'JomSocial' )->addNotification( JText::sprintf( 'COM_EASYBLOG_JOMSOCIAL_NOTIFICATIONS_NEW_RATING_FOR_YOUR_BLOG' , $author->getName() , $blog->title ) , 'easyblog_new_blog' , $target , $this->created_by , $link );
			}
