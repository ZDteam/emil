...
?>
	<form action="index.php" method="post" name="adminForm" autocomplete="off" id="adminForm">
		...
		<input type="hidden" name="id" value="<?php echo JVersion::isCompatible("1.6.0")? $this->component->extension_id: $this->component->id;?>" />
		<input type="hidden" name="component" value="<?php echo JVersion::isCompatible("1.6.0")? $this->component->element: $this->component->option;?>" />
