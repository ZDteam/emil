						...
						<?php
								...
								if (JVersion::isCompatible("1.6.0")) {
									if ($mainframe->isAdmin()){
										...
										$cimg = '<img src="'.JURI::root().'administrator/templates/bluestork/images/admin/'. $cimg .'" border="0" alt="'. $walt .'" style="height:16px;border:none;" /></a>';
									}
								}
								else {
									if ($mainframe->isAdmin()){
										...
										$cimg = '<img src="'.JURI::root().'administrator/images/'. $cimg .'"  alt="'. $walt .'" style="height:16px;border:none;" /></a>';
									}
								}
