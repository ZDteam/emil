...
class EasyBlogSocialButtonHelper
{
	...
	public function linkedin()
	{
		...
		if( $linkedin )
		{
			...
			$html .= EasyBlogHelper::addScriptDeclaration('$("#' . $placeholder . '").bookmarklet("linkedIn", {
				url: "'.$dataURL.'",
				counter: "'.$counter.'"
			});');
		}
	...
	public function digg()
	{
		...
		if( $digg )
		{
			...
			$html .= EasyBlogHelper::addScriptDeclaration('$("#' . $placeholder . '").bookmarklet("digg", {
				url: "'.$dataURL.'",
				title: "'.$dataTitle.'",
				classname: "'.$class.'"
			});');
	...
	public function stumbleupon()
	{
		...
		if( $stumbleupon )
		{
			...
			$html .= EasyBlogHelper::addScriptDeclaration('$("#' . $placeholder . '").bookmarklet("stumbleUpon", {
				url: "'.$dataURL.'",
				layout: "'.$counter.'"
			});');
		}
	...
	public function twitter()
	{
		...
		if( $twitter )
		{
			...
			$html .= EasyBlogHelper::addScriptDeclaration('$("#' . $placeholder . '").bookmarklet("twitter", {
				url: "'.$dataURL.'",
				via: "' . $screenname . '",
				count: "'.$style.'",
				text: "' . $dataTitle . '"
	...
	public function googleone()
	{
		...
		if( $googleone )
		{
			...
			$html .= EasyBlogHelper::addScriptDeclaration('$("#' . $placeholder . '").bookmarklet("googlePlusOne", {
				href: "'.$dataURL.'",
				size: "'.$size.'"
			});');
		}
