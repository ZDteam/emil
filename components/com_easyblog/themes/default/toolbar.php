...
<?php } ?>
		...
		<?php if( $system->config->get('layout_toolbar') ){ ?>
						...
						<div class="user-options pabs toggle-show" style="display:none;">
							...
							<ul class="reset-ul">
								<li class="user-info">
									...
									<a href="<?php echo EasyBlogRouter::_( 'index.php?option=com_easyblog&view=dashboard&layout=profile');?>" class="avatar user-avatar float-r">
									...
									<div class="dashboard-user">
										...
										<?php if( $system->config->get( 'toolbar_editprofile' ) ){ ?>
										<br />
										<a href="<?php echo EasyBlogRouter::_('index.php?option=com_easyblog&view=dashboard&layout=profile'); ?>" class="fss"><?php echo JText::_( 'COM_EASYBLOG_TOOLBAR_DASHBOARD_EDIT_PROFILE' );?></a>
										<?php } ?>
									</div>
								</li>
