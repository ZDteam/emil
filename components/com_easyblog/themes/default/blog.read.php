	...
	<div id="entry-<?php echo $blog->id; ?>" class="blog-read clearfix">
		...
		<div class="blog-text clearfix prel mtm mbm">
			...
			<div style="text-align:center;">
				<a href="<?php echo $blog->getImage()->getSource('original');?>" class="easyblog-thumb-preview" title="<?php echo $this->escape( $blog->title );?>"><img src="<?php echo $blog->getImage()->getSource( 'entry' );?>" class="blog-image" /></a>
			</div>
			<?php } ?>
