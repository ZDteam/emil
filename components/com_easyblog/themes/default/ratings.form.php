...
<form id="<?php echo $elementId; ?>-form" itemprop="aggregateRating" itemscope itemtype="http://schema.org/AggregateRating">
	...
	<div id="<?php echo $elementId; ?>" class="star-location prel<?php if( $voted ){ echo " voted"; } ?>" itemprop="reviewBody" >
		...
		<input type="hidden" id="<?php echo $elementId; ?>-rating" value="<?php echo $rating;?>" itemprop="reviewRating" />
