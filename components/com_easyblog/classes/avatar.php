...
class EasyBlogAvatarJomWall
{
	function _init()
	{
		$files	= JPATH_ROOT . DIRECTORY_SEPARATOR . 'components' . DIRECTORY_SEPARATOR . 'com_awdwall' . DIRECTORY_SEPARATOR . 'helpers' . DIRECTORY_SEPARATOR . 'user.php';
...
class EasyBlogAvatarK2
{
	function _init()
	{
		$files	= JPATH_ROOT . DIRECTORY_SEPARATOR . 'components' . DIRECTORY_SEPARATOR . 'com_k2' . DIRECTORY_SEPARATOR . 'k2.php';
...
class EasyBlogAvatarMightyTouch
{
	function _init()
	{
		$file	= JPATH_ROOT . DIRECTORY_SEPARATOR . 'components' . DIRECTORY_SEPARATOR . 'com_juser' . DIRECTORY_SEPARATOR . 'api.php';
