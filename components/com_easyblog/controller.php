	...
	function display( $cachable = false, $urlparams = false )
	{
		...
		else
		{
			...
			if( JRequest::getVar( 'tmpl' ) != 'component')
			{
				...
				echo '<div id="eblog-wrapper" class="eblog-' . $theme . ' eblog-' . $headingFont . $suffix . $bootstrap . '">';
			}
			...
			if( $config->get( 'integrations_jomsocial_toolbar' ) && $format != 'pdf' && $format != 'phocapdf' && $tmpl != 'component' || $showJomsocial )
			{
				if(JFile::exists(JPATH_ROOT . DIRECTORY_SEPARATOR . 'components' . DIRECTORY_SEPARATOR . 'com_community' . DIRECTORY_SEPARATOR . 'libraries' . DIRECTORY_SEPARATOR .'core.php'))
				{
					...
					require_once( JPATH_ROOT . DIRECTORY_SEPARATOR . 'components' . DIRECTORY_SEPARATOR . 'com_community' . DIRECTORY_SEPARATOR . 'libraries' . DIRECTORY_SEPARATOR .'toolbar.php' );
			...
			if( !$print && $format != 'pdf' && $format != 'phocapdf' && $tmpl != 'component' && !$hideToolbar )
			{
				if( $view->getName() != 'dashboard' )
				{
					echo $this->getToolbar( $view->getName() );
				}
			}
