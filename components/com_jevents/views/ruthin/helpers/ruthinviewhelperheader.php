...
function RuthinViewHelperHeader($view){
...
?>
<table class="contentpaneopen jeventpage<?php echo $params->get( 'pageclass_sfx' ); echo $params->get("darktemplate",0)?" jeventsdark":" "; echo $lang->isRTL()?" jevrtl":"jeventslight ";?>" id="jevents_header">
	<tr>
