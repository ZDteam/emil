	...
	<thead>
		<tr>
			...
			<th width="5%" nowrap="nowrap">
				<?php echo JHTML::_('grid.sort',  'Published', 'loc.published', $this->lists['order_Dir'], $this->lists['order'] , "people.list"); ?>
			</th>
			<th width="5%" nowrap="nowrap">
			...
			<th width="5%">
				<?php echo JHTML::_('grid.sort',  'Country', 'loc.catid', $this->lists['order_Dir'], $this->lists['order'] , "people.list"); ?>
			</th>
			<th width="5%">
				<?php echo JHTML::_('grid.sort',  'State', 'loc.catid1', $this->lists['order_Dir'], $this->lists['order'] , "people.list"); ?>
			</th>
			<th width="5%">
				<?php echo JHTML::_('grid.sort',  'City', 'loc.catid2', $this->lists['order_Dir'], $this->lists['order'] , "people.list"); ?>
			</th>
